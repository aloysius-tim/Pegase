...
<main class="padding-side-nav">
    <div class="row logo-color" id="index-banner">
        <div class="container">
            ...
            <div class="col s12">
                <h2 class="white-text center-on-small-only font-weight-lower"><a href="<?=base_url()?>admin/generation" class="white-text"><i class="mdi-navigation-arrow-back"></i></a> Détail fiche de renseignement</h2>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                <div class="row">
                    <a class="waves-effect waves-light btn modal-trigger col s12 m12 blue" href="<?=base_url()?>admin/detail_fiche_renseignement/convention/<?=$identifiant?>" target="_blank">Voir convention</a>
                    <a class="waves-effect waves-light btn modal-trigger col s12 m12 blue" href="<?=base_url()?>admin/depot_etudiant/index/<?=$identifiant?>" target="">Voir les dépots de cet étudiant</a>
                    ...
                    <?php
                        if($soumis==1 && $valide==0){
                            ...
                            <a href="'.base_url().'admin/detail_fiche_renseignement/valider/'.$identifiant.'" class="btn col s12 m6 green">Valider les renseignements</a>
                            <a class="waves-effect waves-light btn modal-trigger col s12 m12 red" href="'.base_url().'admin/detail_fiche_renseignement/refuser/'.$identifiant.'" target="">Refuser la fiche de renseignement -> Incorrecte</a>';
                        }
                    ?>
