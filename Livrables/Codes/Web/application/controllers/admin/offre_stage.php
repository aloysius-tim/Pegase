...
class Offre_stage extends CI_Controller {
    ...
    public function page($offset=0){
        ...
        $data['nbOffreNonValide']=$this->offre->getNbOffresNonValides();
    ...
    public function language($nom, $idLanguage, $offset=0){
        ...
        $data['pagination']=$this->_generatePagination(sizeof($this->offre->getOffresValides(NULL, 0, $idLanguage)), 'admin/offre_stage/language/'.$nom.'/'.$idLanguage.'/', 6);
        $data['orientations']=$this->attribut->getOrientations();
        $data['languages']=$this->attribut->getLanguages();
        $data['nbOffreNonValide']=$this->offre->getNbOffresNonValides();
    ...
    public function orientation($nom, $idOrientation, $offset=0){
        ...
        $data['pagination']=$this->_generatePagination(sizeof($this->offre->getOffresValides(NULL, 0, NULL, $idOrientation)), 'admin/offre_stage/orientation/'.$nom.'/'.$idOrientation.'/', 6);
        $data['orientations']=$this->attribut->getOrientations();
        $data['languages']=$this->attribut->getLanguages();
        $data['nbOffreNonValide']=$this->offre->getNbOffresNonValides();
    ...
    public function systeme($nom, $idSysteme, $offset=0){
        ...
        $data['pagination']=$this->_generatePagination(sizeof($this->offre->getOffresValides(NULL, 0, NULL, NULL, $idSysteme)), 'admin/offre_stage/systeme/'.$nom.'/'.$idSysteme.'/', 6);
        $data['orientations']=$this->attribut->getOrientations();
        $data['languages']=$this->attribut->getLanguages();
        $data['nbOffreNonValide']=$this->offre->getNbOffresNonValides();
    ...
    function _generatePagination($totalRow, $url='admin/offre_stage/page/', $uriSegment=4){
